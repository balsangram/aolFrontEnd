  ...
  return (
    <div
      style={{
        ...
        // boxShadow: "5px 1px 8px rgb(136 136 136 / 28%)",
        background: "linear-gradient(45deg,rgb(23, 22, 21),rgb(255, 132, 0),rgb(255, 173, 58))", 
        // borderRadius: "8px",
        padding: "0 2rem",
...
//                                         <Link to="/signin" className="text-danger !py-3">
